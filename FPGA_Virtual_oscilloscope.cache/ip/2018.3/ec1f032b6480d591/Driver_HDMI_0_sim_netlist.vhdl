...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_Driver_HDMI is
  ...
  signal \Set_Y0_carry__0_i_1_n_0\ : STD_LOGIC;
  signal \Set_Y0_carry__0_i_2_n_0\ : STD_LOGIC;
  signal \Set_Y0_carry__0_i_3_n_0\ : STD_LOGIC;
  signal \Set_Y0_carry__0_i_4_n_0\ : STD_LOGIC;
...
\Set_Y0_carry__0\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3 downto 2) => B"00",
      DI(1) => \Set_Y0_carry__0_i_1_n_0\,
      DI(0) => \Set_Y0_carry__0_i_2_n_0\,
      O(3 downto 0) => \NLW_Set_Y0_carry__0_O_UNCONNECTED\(3 downto 0),
      S(3 downto 2) => B"00",
      S(1) => \Set_Y0_carry__0_i_3_n_0\,
      S(0) => \Set_Y0_carry__0_i_4_n_0\
    );
\Set_Y0_carry__0_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
      I0 => VSync_Cnt_reg(10),
      I1 => VSync_Cnt_reg(11),
      O => \Set_Y0_carry__0_i_1_n_0\
    );
\Set_Y0_carry__0_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
      I0 => VSync_Cnt_reg(8),
      I1 => VSync_Cnt_reg(9),
      O => \Set_Y0_carry__0_i_2_n_0\
    );
\Set_Y0_carry__0_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
      I0 => VSync_Cnt_reg(10),
      I1 => VSync_Cnt_reg(11),
      O => \Set_Y0_carry__0_i_3_n_0\
    );
\Set_Y0_carry__0_i_4\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
